...
public class TestRecords {
    ...
    public static void records(){
        ...
        System.out.println(p1);                         // Person.java[name=Joe Bloggs, age=22]
    ...
    public static void patternMatching(Object obj){
        // "Person.java person" is a "type pattern". At runtime, "pattern matching" is
        // performed by instanceof to see if "obj" is referring to a Person.java object;
        // is so, "person" is made to refer to that Person.java object.
