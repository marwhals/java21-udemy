...
//        nonNesting(p2);  // Mary Bloggs; 23
    ...
    public static void nonNesting(Object obj){
        // Person.java(String s, Integer nAge) is a "record pattern" which does 2 things:
        //   1. Tests whether the object is of type Person.java (as usual)
...
//        if (dbles instanceof Doubles(Player pl1, Player pl2)) {   // LVTI works also
        if (dbles instanceof Doubles(var pl1, var pl2)) {   // LVTI works also
            System.out.println(pl1.person() + "; " + pl1.ability());
            System.out.println(pl2.person() + "; " + pl2.ability());
        }
        // more complex nesting
        if (dbles instanceof Doubles(Player(Person p1, Ability ability), var pl2)) { // LVTI works also --- i.e using vars to use type inference
